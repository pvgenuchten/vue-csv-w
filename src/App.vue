...
<h1 class="mb-4">CSVW Browser Editor</h1>
<CSVUploader @csv-loaded="onCsvLoaded" />
<CSVWClientParser v-if="csvText" :csvRows="csvRows" :csvHeaders="csvHeaders" :csvText="csvText" />
</div>
</template>
...
data() { return { csvRows: [], csvHeaders: [], csvText: '' } },
methods: {
